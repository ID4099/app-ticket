...
import { Box, Typography, Stack, Grid, Tooltip, Button } from "@mui/material";
...
function TaskDetails({ task }: any){
    ...
    React.useEffect(() => {
        ...
        setTicketDescription(task.description);
        setTicketType(task.type);
        setTicketStatus(task.status);
        setTicketPriority(task.priority)
    }, [task]);
        ...
        <Box sx={{ flexGrow: 1, margin: 1 }}>
            ...
            <Stack direction="row" justifyContent={"space-between"}>
                    <Stack direction="column">
                        <Typography variant="h5" marginTop={3} marginBottom={1}>{TicketTitle}</Typography>
                    </Stack>
                    <Stack direction="column">
                        <Stack marginTop={2.5} />
            ...
            <Box marginTop={5} marginBottom={5}>
                ...
                <Stack spacing={2} marginTop={4} direction="column">
                    <Button variant="contained" type="submit" onClick={handleSave}>Guardar Cambios</Button>
                </Stack>
            </Box>
